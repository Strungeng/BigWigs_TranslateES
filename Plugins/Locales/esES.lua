...
L.modifierDesc = "Presiona la tecla de modificador elegida para activar acciones de clics en los tiempos de las barras."
...
L.blockEmotes = "Bloquear emoticonos del centro de la pantalla"
L.blockEmotesDesc = "Algunos jefes muestran emoticonos para ciertas habilidades, estos mensajes son demasiado largos y descriptivos. Intentamos acortarlos, y ajustarlos para que no interfieran con el juego, y que no te digan específicamente que tienes que hacer.\n\nTen en cuenta: Los emotes de Jefe seguirán siendo visibles en el chat si deseas leerlos."
...
L.blue = "Azul"
L.blueDesc = "Avisos para cosas que te afecta a ti directamente como un debuffo siendo aplicado a ti."
L.orange = "Naranja"
L.yellow = "Amarillo"
L.green = "Verde"
L.greenDesc = "Avisos para cosas buenas que ocurren, como un debuffo siendo eliminado de ti."
L.cyan = "Cian"
L.cyanDesc = "Avisos para cambios de estados durante un encuentro como el avance a la siguiente fase."
L.purple = "Púrpura"
L.purpleDesc = "Avisos para habilidades específicas para tanques como acumulaciones de un debuffo en un tanque."
