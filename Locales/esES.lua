...
L.RunAway = "Huye pequeña (El Lobo Feroz)"
...
L.zoneMessagesDesc = "Desactivar esto dejará de mostrar mensajes cuando entres en una zona donde BigWigs tenga un módulo pero no lo tengas instalado. Recomendamos que dejes esto activo pues será la única notificación que recibirás si creamos módulos nuevos para una zona que encontréis útil"
